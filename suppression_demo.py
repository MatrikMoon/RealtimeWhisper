...
# VAD = VAD.from_hparams(source="speechbrain/vad-crdnn-libriparty", savedir="pretrained_models/vad-crdnn-libriparty", local_strategy=LocalStrategy.COPY)
...
path = 'suppression_demo.wav'
prob, segments = detect_voice(path)

segments['gain'] = 0.0

out_path = 'suppression_out.wav'
